...
# python train_fl.py --batch-size 32 --wandb --wandb-log-images --backbone resnet34 --wandb-run-name fl-no-transform-background_on-resnet34_warmup_1_bs32_gpu3_resolutions_512_256_128 --lr-warmup-epochs 1 --client-resolutions 512 256 128 --mrkd --device-id 1
...
# [CL] test
python train.py --batch-size 8 --backbone vit_small --wandb --wandb-run-name cl-vit_small-512_gpu0 --device-id 0 --cl-resolutions 512
python train.py --batch-size 8 --backbone vit_small --wandb --wandb-run-name cl-vit_small-512-256-128_gpu0 --device-id 0 --cl-resolutions 512 256 128

python train_fl.py --batch-size 8 --backbone vit_small --wandb --wandb-run-name fl-vit_small-512-256-128_gpu0 --client-resolutions 512 256 128 --device-id 0
python train_fl.py --batch-size 8 --backbone vit_small --wandb --wandb-run-name fl_mrkd-vit_small-512-256-128_gpu0 --client-resolutions 512 256 128 --mrkd --device-id 0